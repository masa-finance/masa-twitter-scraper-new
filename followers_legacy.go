...
// FetchFollowersLegacy gets the list of followers for a given user, via the Twitter Legacy frontend GraphQL API.
func (s *Scraper) FetchFollowersLegacy(username string, maxUsersNbr int, cursor string) ([]Legacy, string, error) {
	if maxUsersNbr > 200 {
		maxUsersNbr = 200
	}
